...
////    public ResponseEntity<CustomMessage> handleResourceNotFoundExceptions(Exception ex) {
////        CustomMessage customMessage = new CustomMessage();
////        customMessage.setErrorMessage(ex.getMessage() + "Method Not Allowed");
...
//        CustomMessage customMessage = new CustomMessage();
//        customMessage.setErrorMessage(ex.getMessage() + "Method Not Allowed for examplt post get");
//        customMessage.setErrorCode(405);
//        logger.info("here");
